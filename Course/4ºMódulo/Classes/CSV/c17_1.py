...
# Ele é amplamente utilizado para transferir dados entre sistemas de diferentes plataformas
# Como, por exemplo, para importar ou exportar dados para uma planilha (Google Sheets, Excel, LibreOffice Calc) ou para uma base de dados.
...
# A primeira linha do arquivo define os nomes das colunas
# Enquanto as linhas seguintes contêm os valores das linhas, separados por vírgulas.
