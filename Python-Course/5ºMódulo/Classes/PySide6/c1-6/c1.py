...
# - Por usarem a mesma biblioteca (Qt), PySide e PyQt são extremamente similares, muitas vezes os códigos são idênticos. 
# Portanto, mesmo que você ainda queira usar PyQt, será muito simples portar os códigos. 
# Muitas vezes basta trocar o nome de PySide para PyQt e vice-versa.
# - A maior diferença entre PyQt e PySide está na licença:
#       • PyQt usa GPL ou commercial
#       • PySide usa LGPL.
