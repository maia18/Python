...
CAMINHO_ZIP_DIR = CAMINHO_RAIZ / 'class_22_diretorio_zip'
CAMINHO_COMPACTADO = CAMINHO_RAIZ / 'class22_compactado.zip'
CAMINHO_DESCOMPACTADO = CAMINHO_RAIZ / 'class22_descompactado'
